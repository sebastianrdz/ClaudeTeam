...
5. External publishing (posting, sending, submitting listings) is always a proposal for the user to execute — prepare the asset and the steps, never publish yourself.
